...
const IconSettings: Component = () => <Settings class={iconClass} />;
const IconBasic: Component = () => <SlidersHorizontal class={iconClass} />;
const IconLlm: Component = () => <Bot class={iconClass} />;
const IconIm: Component = () => <MessageCircle class={iconClass} />;
const IconWebReq: Component = () => <Search class={iconClass} />;
const IconMemory: Component = () => <Brain class={iconClass} />;
const IconCapabilities: Component = () => <ListChecks class={iconClass} />;
const IconLuaModules: Component = () => <Code2 class={iconClass} />;
const IconFiles: Component = () => <Folder class={iconClass} />;
const IconWebIm: Component = () => <MessageCircle class={iconClass} />;
const IconCamera: Component = () => <Camera class={iconClass} />;
const IconSensors: Component = () => <Gauge class={iconClass} />;
const IconActuators: Component = () => <Wrench class={iconClass} />;
const IconMedia: Component = () => <Music class={iconClass} />;
...
export const NAV_TREE: NavNode[] = [
  { kind: 'leaf', id: 'status', labelKey: 'navStatus', icon: IconStatus },
  {
    ...
    icon: IconSettings,
    children: [
      { kind: 'leaf', id: 'basic', labelKey: 'navBasic', icon: IconBasic },
      { kind: 'leaf', id: 'llm', labelKey: 'navLlm', icon: IconLlm },
      { kind: 'leaf', id: 'im', labelKey: 'navIm', icon: IconIm },
      { kind: 'leaf', id: 'webreq', labelKey: 'navWebReq', icon: IconWebReq },
      { kind: 'leaf', id: 'memory', labelKey: 'navMemory', icon: IconMemory },
      { kind: 'leaf', id: 'capabilities', labelKey: 'navCapabilities', icon: IconCapabilities },
      { kind: 'leaf', id: 'skills', labelKey: 'navLuaModules', icon: IconLuaModules },
  ...
  { kind: 'leaf', id: 'devices', labelKey: 'navDevices', icon: IconActuators },
  { kind: 'leaf', id: 'sensors', labelKey: 'navSensors', icon: IconSensors },
  { kind: 'leaf', id: 'actuators', labelKey: 'navActuators', icon: IconActuators },
  { kind: 'leaf', id: 'media', labelKey: 'navMedia', icon: IconMedia },
];
