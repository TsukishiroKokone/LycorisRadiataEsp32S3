...
const DevicesPage = lazy(() =>
  import('./pages/DevicesPage').then((mod) => ({ default: mod.DevicesPage })),
);
const ModuleLabPage = lazy(() =>
  import('./pages/ModuleLabPage').then((mod) => ({ default: mod.ModuleLabPage })),
);
        ...
        fallback={
          <Layout currentTab={currentTab() as TabId} onSelectTab={handleSelectTab}>
            ...
            >
              ...
              <Show when={currentTab() === 'devices'}>
                <DevicesPage />
              </Show>
              <Show when={currentTab() === 'sensors'}>
                <ModuleLabPage category="sensors" />
              </Show>
              <Show when={currentTab() === 'actuators'}>
                <ModuleLabPage category="actuators" />
              </Show>
              <Show when={currentTab() === 'media'}>
                <ModuleLabPage category="media" />
              </Show>
            </Suspense>
          </Layout>
        }
