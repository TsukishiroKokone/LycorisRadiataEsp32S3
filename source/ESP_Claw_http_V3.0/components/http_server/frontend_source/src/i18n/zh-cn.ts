...
export const zhCn: Dict = {
  ...
  cameraStreamOn: '开启视频',
  cameraStreamOff: '关闭视频',
  cameraVideoTab: '视频',
  cameraAudioTab: '音频',
  cameraAudioLoopback: '录音播放',
  cameraAudioRunning: '录音播放中...',
  cameraAudioDone: '录音播放完成：',
  cameraAudioFailed: 'USB Audio Class 录音播放失败，请先停止视频，再检查 USB 摄像头麦克风和喇叭，必要时重新插拔摄像头。',
  cameraAudioTimeout: '录音播放已结束或请求超时，请稍后再试。',
  cameraAudioHint: '点击后会走和设备 API 相同的 USB Audio Class 路径：先播放提示音，再录制约 10 秒 USB 摄像头麦克风声音，录音结束后通过摄像头喇叭播放；测试前请先关闭视频。',

  navDevices: '设备',
  devicesDescription: '控制舵机、步进电机和 WS2812 灯环，通过 GPIO 引脚连接。',
  devicesServo: '舵机',
  devicesStepper: '步进电机',
  devicesLed: '灯环',
  devicesServoDesc: '选择 GPIO 引脚并调节角度。舵机信号线接所选 GPIO，电源需外接。',
  devicesStepperDesc: '通过 ULN2003 驱动板测试 28BYJ-48 步进电机。IN1-IN4 默认使用 GPIO 46、17、18、21。电机必须外接 5V，且与 ESP32 共地。',
  devicesStepperMode: '运动方式',
  devicesStepperSteps: '步',
  devicesStepperDegrees: '角度',
  devicesStepperDegreesSymbol: '度',
  devicesStepperRevolutions: '圈数',
  devicesStepperAmount: '数值',
  devicesStepperRpm: 'RPM',
  devicesStepperCw: '顺时针',
  devicesStepperCcw: '逆时针',
  devicesStepperReleaseAfter: '运动后断电',
  devicesStepperMove: '运行',
  devicesStepperRunning: '运行中...',
  devicesStepperRelease: '断电释放',
  devicesChannel: '通道',
  devicesEnable: '使能',
  devicesLedDesc: '控制 WS2812 灯环，数据线默认使用 GPIO 38。',
  devicesLedCount: 'LED数',
  devicesLedColor: '颜色',
  devicesLedBrightness: '亮度',
  devicesLedApply: '应用',
  devicesLedOff: '关闭',
  devicesDht11: '温湿度',
  devicesDht11Desc: '每 2 秒自动读取 DHT11 传感器数据，默认使用 GPIO 40。',
  devicesDht11Temp: '温度',
  devicesDht11Hum: '湿度',
  devicesDht11Refresh: '刷新',
};
