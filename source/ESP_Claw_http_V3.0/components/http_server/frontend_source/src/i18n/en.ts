export const en = {
  ...
  cameraStreamOn: 'Start Stream',
  cameraStreamOff: 'Stop Stream',
  cameraVideoTab: 'Video',
  cameraAudioTab: 'Audio',
  cameraAudioLoopback: 'Record and Play',
  cameraAudioRunning: 'Recording and playing...',
  cameraAudioDone: 'Audio loopback complete:',
  cameraAudioFailed: 'USB Audio Class loopback failed. Stop video, check the USB camera microphone and speaker, then replug the camera if needed.',
  cameraAudioTimeout: 'Audio loopback finished or timed out. Try again later.',
  cameraAudioHint: 'Click to use the same USB Audio Class path as the device API: play prompt tones, record about 10 seconds from the USB camera microphone, then play it back through the camera speaker. Stop video before testing audio.',

  navDevices: 'Devices',
  devicesDescription: 'Control servo motors and WS2812 LED ring connected to GPIO pins.',
  devicesServo: 'Servo',
  devicesStepper: 'Stepper',
  devicesLed: 'LED Ring',
  devicesServoDesc: 'Select GPIO pin and adjust angle for each servo channel. Connect servo signal wire to the selected GPIO, power externally.',
  devicesStepperDesc: 'Test a 28BYJ-48 stepper through a ULN2003 driver. IN1-IN4 default to GPIO 46, 17, 18, 21. Use an external 5V motor supply and common GND.',
  devicesStepperMode: 'Move by',
  devicesStepperSteps: 'Steps',
  devicesStepperDegrees: 'Degrees',
  devicesStepperDegreesSymbol: 'deg',
  devicesStepperRevolutions: 'Revolutions',
  devicesStepperAmount: 'Amount',
  devicesStepperRpm: 'RPM',
  devicesStepperCw: 'Clockwise',
  devicesStepperCcw: 'Counterclockwise',
  devicesStepperReleaseAfter: 'Release after move',
  devicesStepperMove: 'Move',
  devicesStepperRunning: 'Running...',
  devicesStepperRelease: 'Release',
  devicesChannel: 'Channel',
  devicesEnable: 'Enable',
  devicesLedDesc: 'Control WS2812 LED ring. Data line is on GPIO 38 by default.',
  devicesLedCount: 'LEDs',
  devicesLedColor: 'Color',
  devicesLedBrightness: 'Brightness',
  devicesLedApply: 'Apply',
  devicesLedOff: 'Off',
  devicesDht11: 'DHT11',
  devicesDht11Desc: 'Auto-reads temperature & humidity from DHT11 sensor on GPIO 40 every 2 seconds.',
  devicesDht11Temp: 'Temperature',
  devicesDht11Hum: 'Humidity',
  devicesDht11Refresh: 'Refresh',
};
