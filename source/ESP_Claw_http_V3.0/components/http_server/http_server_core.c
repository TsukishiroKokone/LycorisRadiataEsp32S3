...
esp_err_t http_server_start(void)
{
    ...
    ESP_RETURN_ON_ERROR(http_server_register_module_routes(s_ctx.server), TAG, "Failed to register module routes");
    ...
    ESP_RETURN_ON_ERROR(http_server_register_devices_routes(s_ctx.server), TAG, "Failed to register devices routes");
...
{
    (void)http_server_stop_camera_stream_server();
